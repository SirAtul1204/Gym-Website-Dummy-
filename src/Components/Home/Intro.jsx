...
class Intro extends Component {
	...
	componentDidMount = () => {
		...
		unsplash.search
			...
			.then((data) => {
				console.log(data);
				let imgIntro = data["results"][Math.floor(Math.random() * 25)]["urls"]["raw"];
	...
	render() {
		return (
			<React.Fragment>
				<div className="intro">
					<p>
						This is dummy website for a gym just to showcase my web dev skills. No
						information given here is real.
					</p>
